    ...
    <header>
      <div class="wrapper">
        ...
        <div class="right">
          ...
          <nav>
            <ul id="menu">
              <li><a href="http://localhost/FRONT_END/index.php">Home</a></li>
              <li><a href="http://localhost/FRONT_END/aircrafts.php">Train_Details</a></li>
              <li><a href="http://localhost/FRONT_END/safety.php">Stations</a></li>
              <li id="menu_active"><a href="http://localhost/FRONT_END/charters.php">Users</a></li>
              <!--<li><a href="http://localhost/FRONT_END/contacts.php">Contacts</a></li>
			  --><li><a href="http://localhost/FRONT_END/b.php">Login</a></li>
            </ul>
          </nav>
        </div>
      </div>
...
<a align = "center" href="http://localhost/FRONT_END/index.php">Back to homepage</a>
<!--
<div class="main">
  <div id="bannerr">
  ...
  <section id="content">
    <article class="col1">
      ...
      <div class="wrapper pad_bot1">
        ...
        <div class="wrapper pad_bot2"><a href="http://localhost/FRONT_END/waitng_list.php" class="button2">Waiting List</a></div>
